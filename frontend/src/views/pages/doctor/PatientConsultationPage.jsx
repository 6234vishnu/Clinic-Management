...
const PatientConsultationPage = () => {
    ...
    const getPatients = async () => {
      try {
        const response = await api.get(
          `/doctor/getpatients?doctorId=${doctorId}`
        );
  ...
  useEffect(() => {
    ...
    const getAppointments = async () => {
      try {
        const response = await api.get(
          `/doctor/getPatientsAppoinment?patientId=${selectedPatient._id}`
        );
        if (response.data.success) {
        ...
        console.error(
          "Error in getAppointments PatientConsultationPage",
          error
        );
        setErrorMessage("Server error");
      }
  ...
  const handleSubmitPrescription = async (e, patientId, appointmentId) => {
    ...
    try {
      ...
      const response = await api.post("/doctor/attendAppoinment", {
        prescription,
        patientId,
        appointmentId,
      });
      ...
      console.log(
        "error in handleSubmitPrescription in doctor patient consultation page",
        error
      );
    ...
    return (
      <>
        ...
        <div className="PatientConsulDocContainer">
          <div style={{ color: "white" }} className="PatientConsulDocLoading">
            Loading patient data ... or no appointments today
          </div>
        </div>
      </>
    );
    ...
    <>
      ...
      <div className="PatientConsulDocContainer">
        ...
        {successMessage && (
          <div
            style={{ color: "green" }}
            className="PatientConsulDocSuccessMessage"
          >
            {successMessage}
          </div>
        )}
        ...
        {errorMessage && (
          <div
            style={{ color: "red" }}
            className="PatientConsulDocErrorMessage"
          >
            {errorMessage}
          </div>
        )}
              ...
              <div className="PatientConsulDocModalBody">
                <div className="PatientConsulDocInfo">
                  ...
                  <div className="PatientConsulDocRow">
                    ...
                    <span className="PatientConsulDocValue">
                      <span
                        className={`PatientConsulDocStatusBadge ${appointmentData?.status}`}
                      >
