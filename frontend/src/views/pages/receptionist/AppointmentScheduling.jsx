...
import { Calendar, Clock, User, UserPlus, CheckCircle, XCircle, AlertTriangle } from 'lucide-react';
...
const AppointmentScheduling = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response=await api.post('/receptionist/doctorAppoinment',{formData})
      ...
      <div className="appointmentRecepCard">
        ...
        {submitStatus === 'success' && !isFormVisible && (
          <div className="appointmentRecepSuccessMessage">
            ...
            <p>Appointment has been successfully created for {getPatientById(formData.patient).name} with {getDoctorById(formData.doctor).name} on {new Date(formData.date).toLocaleDateString()} at {formData.timeSlot}.</p>
          </div>
        )}
        ...
        {submitStatus === 'error' && (
          <div className="appointmentRecepErrorMessage">
            ...
            <p>There was a problem scheduling the appointment. Please try again.</p>
          </div>
        )}
            ...
            <div className="appointmentRecepSection">
              ...
              <div className="appointmentRecepFormGroup">
                <label htmlFor="patient" className="appointmentRecepLabel">
                  Select Patient <span className="appointmentRecepRequired">*</span>
                </label>
                <div className="appointmentRecepSelectWrapper">
                  <select
                    ...
                    className={`appointmentRecepSelect ${errors.patient ? 'appointmentRecepInputError' : ''}`}
                  >
            ...
            <div className="appointmentRecepSection">
              ...
              <div className="appointmentRecepFormGroup">
                <label htmlFor="doctor" className="appointmentRecepLabel">
                  Select Doctor <span className="appointmentRecepRequired">*</span>
                </label>
                <div className="appointmentRecepSelectWrapper">
                  <select
                    id="doctor"
                    ...
                    onChange={handleChange}
                    className={`appointmentRecepSelect ${errors.doctor ? 'appointmentRecepInputError' : ''}`}
                  >
              ...
              <div className="appointmentRecepFormRow">
                <div className="appointmentRecepFormGroup">
                  <label htmlFor="date" className="appointmentRecepLabel">
                    Appointment Date <span className="appointmentRecepRequired">*</span>
                  </label>
                  <div className="appointmentRecepInputWrapper">
                    <Calendar size={18} className="appointmentRecepInputIcon" />
                    <input
                      type="date"
                      id="date"
                      name="date"
                      ...
                      min={getMinDate()}
                      max={getMaxDate()}
                      className={`appointmentRecepInput ${errors.date ? 'appointmentRecepInputError' : ''}`}
                    />
                  </div>
                  {errors.date && (
                    <div className="appointmentRecepErrorText">
                ...
                <div className="appointmentRecepFormGroup">
                  <label htmlFor="timeSlot" className="appointmentRecepLabel">
                    Time Slot <span className="appointmentRecepRequired">*</span>
                  </label>
                  <div className="appointmentRecepSelectWrapper">
                    ...
                    <select
                      ...
                      className={`appointmentRecepSelect ${errors.timeSlot ? 'appointmentRecepInputError' : ''}`}
                    >
