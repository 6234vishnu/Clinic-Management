...
const PatientRegistration = () => {
  ...
  const handleSubmit =async (e) => {
    ...
    if (isValid) {
      ...
      try {
        const response= await api.post('/receptionist/registerPatient',{formData})
        ...
        <form onSubmit={handleSubmit} className="patientRegisterRecepForm">
          <div className="patientRegisterRecepFormGroup">
            <label htmlFor="name" className="patientRegisterRecepLabel">
              Full Name <span className="patientRegisterRecepRequired">*</span>
            </label>
            <input
              type="text"
              id="name"
              ...
              className={`patientRegisterRecepInput ${errors.name ? 'patientRegisterRecepInputError' : ''}`}
          ...
          <div className="patientRegisterRecepRow">
            <div className="patientRegisterRecepFormGroup patientRegisterRecepHalfWidth">
              ...
              <input
                ...
                value={formData.age}
                onChange={handleChange}
                className={`patientRegisterRecepInput ${errors.age ? 'patientRegisterRecepInputError' : ''}`}
            ...
            <div className="patientRegisterRecepFormGroup patientRegisterRecepHalfWidth">
              ...
              <select
                ...
                onChange={handleChange}
                className={`patientRegisterRecepSelect ${errors.gender ? 'patientRegisterRecepInputError' : ''}`}
              >
          ...
          <div className="patientRegisterRecepFormGroup">
            <label htmlFor="phone" className="patientRegisterRecepLabel">
              Phone Number <span className="patientRegisterRecepRequired">*</span>
            </label>
            <input
              type="tel"
              id="phone"
              ...
              onChange={handleChange}
              className={`patientRegisterRecepInput ${errors.phone ? 'patientRegisterRecepInputError' : ''}`}
          ...
          <div className="patientRegisterRecepFormFooter">
            <button type="reset" className="patientRegisterRecepButtonSecondary">
              Clear Form
            </button>
            <button type="submit" className="patientRegisterRecepButtonPrimary">
              Register Patient
            </button>
          </div>
        </form>
