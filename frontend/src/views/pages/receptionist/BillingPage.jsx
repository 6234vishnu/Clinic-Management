...
const BillingPage = () => {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await api.get("/receptionist/getAppoinments/prescriptions");
  ...
  return (
    <>
      <RecepNav />
        <button
        onClick={()=>navigate("/TotalBills-Page")} style={{
          color:"#2e3a4d",
          backgroundColor:"white",
          borderRadius:"10px",
          marginLeft:"800px"
        }}>Show All Generated Bills </button>
              ...
              <tbody>
                {appointments.map(appointment => (
                  ...
                  >
                    ...
                    <td>
                      <span className={`BillingRecepStatus ${getStatusClass(appointment.status)}`}>
                        {appointment.status}
                      </span>
                    </td>
                    <td>
                    ...
                    <td>
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          setSelectedPrescription(appointment.prescription || "No prescription available.");
                        }}
                      >
                        Show Prescription
                      </button>
              ...
              <div className="BillingRecepAppointmentDetails">
                ...
                <div className="BillingRecepDetailSection">
                  ...
                  <div className="BillingRecepDetailRow">
                    ...
                    <span className="BillingRecepDetailValue">{selectedAppointment.patient?.name}</span>
                  </div>
                  <div className="BillingRecepDetailRow">
                    <span className="BillingRecepDetailLabel">Contact:</span>
                    <span className="BillingRecepDetailValue">{selectedAppointment.patient?.contact}</span>
                  </div>
                  <div className="BillingRecepDetailRow">
                    <span className="BillingRecepDetailLabel">Email:</span>
                    <span className="BillingRecepDetailValue">{selectedAppointment.patient?.email}</span>
                  </div>
                </div>
                ...
                <div className="BillingRecepDetailSection">
                  ...
                  <div className="BillingRecepDetailRow">
                    ...
                    <span className="BillingRecepDetailValue">{selectedAppointment?.doctor?.name} ({selectedAppointment?.doctor?.specialization})</span>
                  </div>
                  <div className="BillingRecepDetailRow">
                    <span className="BillingRecepDetailLabel">Date:</span>
                    <span className="BillingRecepDetailValue">{formatDate(selectedAppointment.date)}</span>
                  </div>
                  <div className="BillingRecepDetailRow">
                    <span className="BillingRecepDetailLabel">Time:</span>
                    <span className="BillingRecepDetailValue">{selectedAppointment.timeSlot}</span>
                  </div>
                  <div className="BillingRecepDetailRow">
                    <span className="BillingRecepDetailLabel">Status:</span>
                    <span className={`BillingRecepDetailValue BillingRecepStatus ${getStatusClass(selectedAppointment.status)}`}>
  ...
  <div className="BillingRecepOverlay">
    <div className="BillingRecepAppointmentDetails">
      ...
      <div className="BillingRecepDetailRow">
        <span className="BillingRecepDetailLabel">Doctor:</span>
        <span className="BillingRecepDetailValue">
          {selectedPrescription?.doctor?.name || 'No doctor available'}
        </span>
      </div>
      ...
      <div className="BillingRecepDetailRow">
        ...
        <span className="BillingRecepDetailValue">
          {new Date(selectedPrescription.createdAt).toLocaleString() || 'No date available'}
        </span>
      </div>
