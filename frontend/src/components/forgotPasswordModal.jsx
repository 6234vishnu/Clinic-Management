      ...
      <div className="forgotPasswordModal-container">
        <div className="forgotPasswordModal-content">
          ...
          <div className="forgotPasswordModal-header">
            ...
            <button className="forgotPasswordModal-close-btn" onClick={onClose}>
              &times;
            </button>
          </div>
          <div className="forgotPasswordModal-body">
            <p>Enter your email to reset password</p>
            <input onChange={(e)=>setEmail(e.target.value)} type="email" className="forgotPasswordModal-input" placeholder="Email" required />
          </div>
          <div className="forgotPasswordModal-footer">
            <button className="forgotPasswordModal-close" onClick={onClose}>
              Close
            </button>
            <button onClick={handleClick} className="forgotPasswordModal-submit">Send OTP to Email</button>
          </div>
        </div>
      </div>
    </div>
    <div>
    <OtpModal show={showOTPModal} onClose={() => setShowOTPModal(false)} activeRole={role} email={email} />
